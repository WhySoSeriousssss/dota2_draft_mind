...
const zhCN = {
  ...
  "draft.algorithm": "推荐算法",
  "draft.algorithmV1": "V1 · 统计评分",
  "draft.algorithmV2": "V2 · LightGBM",
  "draft.predictedWinRate": "预测胜率",
  "draft.v2ApiUnavailable": "V2 接口不存在，请重启或更新后端服务",
...
const en: Record<TranslationKey, string> = {
  ...
  "draft.algorithmV1": "V1 · Statistical Score",
  "draft.algorithmV2": "V2 · LightGBM",
  "draft.predictedWinRate": "Predicted Win Rate",
  "draft.v2ApiUnavailable": "V2 API is unavailable. Restart or update the backend service.",
